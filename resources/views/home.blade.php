...
@section('content')
    <div class="row row-deck row-cards">
        ...
        <div class="containert mt-4">
            {{-- testing only --}}
            <div class="bg-dark text-white py-5 px-5 mb-4 rounded shadow-md">
            <p>User permissions (should move to users edit page)</p>
            @foreach($permissions as $permission)
                <h3>Module: {{ Str::camel($permission['module']) }}</h3>
                ...
                <table class="table  text-white">
                    ...
                    @foreach (\Spatie\Permission\Models\Permission::where('module', $permission['module'])->get() as $perm)
                        <tr>
                            <td>{{ $perm->name }}</td>

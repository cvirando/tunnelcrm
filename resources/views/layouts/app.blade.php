                      ...
                      <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" rel="noopener nofollow" href="https://irando.co.id">
                                    Website
                                </a>
                                <a class="dropdown-item" rel="noopener nofollow" href="https://irando.co.id/contact-us">
                                    Contact Us
                                </a>
                    ...
                    <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                      <ul class="list-inline list-inline-dots mb-0">
                        <li class="list-inline-item">
                          ...
                          <a href="{{url('/')}}" class="link-secondary">{{ config('app.name', 'TunnelCRM') }}</a>.
                          All rights reserved.
                        </li>
                        <li class="list-inline-item">
                          Developed by: <a href="https://irando.co.id" class="link-secondary" rel="noopener">
                            CV. IRANDO
                          </a>
                        </li>
                      </ul>
